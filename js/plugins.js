        ...
        typewrite: function (t, s) {
            if (!0 !== this.stop) {
                ...
                i.timeout = setTimeout(function () {
                    ...
                    if ("^" === r.charAt(0)) {
                        var o = 1;
                        /^\^\d+/.test(r) && (o += (r = /\d+/.exec(r)[0]).length,
                            e = parseInt(r)),
                    ...
                    if ("html" === i.contentType) {
                        ...
                        if ("<" === n || "&" === n) {
                            var a = "";
                            for (a = "<" === n ? ">" : ";"; t.substr(s + 1).charAt(0) !== a && (t.substr(s).charAt(0),
                                !(++s + 1 > t.length));)
                                ;
                            s++,
                                a
            ...
            if (!0 !== this.stop) {
                ...
                i.timeout = setTimeout(function () {
                    if ("html" === i.contentType && ">" === t.substr(s).charAt(0)) {
                        for (; "<" !== t.substr(s - 1).charAt(0) && (t.substr(s).charAt(0),
                            !(--s < 0));)
                            ;
                        s--,
                            "<"
    ...
    return function (t) {
        ...
        , function (t, e, n) {
            ...
            t.exports = function (t, e, n, f, h, g, b) {
                ...
                }, E = e + " Iterator", _ = !1, T = t.prototype, A = T[y] || T["@@iterator"] || h && T[h], j = !v && A || O(h), P = "Array" == e && T.entries || A;
                if (P && (x = i(P.call(new t)),
                    d !== Object.prototype && x.next && (l || i(x) === d || (u ? u(x, d) : "function" != typeof x[y] && a(x, y, m)),
                        c(x, E, !0, !0),
                        l && (p[E] = m))),
                    "values" == h && A && "values" !== A.name && (_ = !0,
                        j = function () {
                            return A.call(this)
                        }
                    ),
            ...
            var r = n(19)
                ...
                , s = function (t) {
                    ...
                    return function (h, d, v, y) {
                        for (var m, g, b = i(h), x = o(b), w = r(d, v, 3), S = u(x.length), O = 0, E = y || c, _ = e ? E(h, S) : n ? E(h, 0) : void 0; S > O; O++)
                            if ((p || O in x) && (g = w(m = x[O], O, b),
                                t))
                                if (e)
                                    _[O] = g;
                                else if (g)
        ...
        , function (t, e, n) {
            ...
            t.exports = function (t) {
                ...
                if (g && (m = r(m, y > 2 ? arguments[2] : void 0, 2)),
                    ...
                    for (p = (l = b.call(d)).next,
                        n = new v; !(f = p.call(l)).done; x++)
    ...
    ***************************************************************************** */
            ...
            var c = /\s/
                ...
                , T = function (t) {
                    ...
                    t = s(t);
                    var n = O.test(t);
                    return n || E.test(t) ? _(t.slice(2), n ? 2 : 8) : S.test(t) ? NaN : +t
                }
                , A = function (t, e, n) {
                    return void 0 === n && (n = e,
                        e = void 0),
            ...
            var M = function () {
                ...
                , z = function (t, e, n) {
                    ...
                    function g() {
                        ...
                        return void 0 === c && (c = setTimeout(y, e)),
                            u
                    }
                    return e = T(e) || 0,
                        f(n) && (l = !!n.leading,
            ...
            function it(t) {
                ...
                u(c, "click", (function (e) {
                    if (!n && W(e.target, [s.element, f.element])) {
                        ...
                        o === tt.Y && (c = u.y - i.top - f.thumb.displaySize / 2,
                    ...
                    i && (cancelAnimationFrame(e),
                        function n(r) {
                            ...
                            if (o || i) {
                                var u = t.offset
                                    , c = t.limit;
                                t.setMomentum(A(u.x + o, 0, c.x) - u.x, A(u.y + i, 0, c.y) - u.y),
            ...
            function at(t) {
                var e, n = t.options.delegateTo || t.containerEl, r = new Y, o = F(t), i = 0;
...
!function (n, t) {
    ...
    function t(r, i, e) {
        if (!r.s) {
            if (e instanceof n) {
                if (!e.s)
                    return void (e.o = t.bind(null, r, i));
                1 & i && (i = e.s),
                    e = e.v
            }
            if (e && e.then)
    ...
    !function () {
        ...
        r.prototype[Symbol.asyncIterator || (Symbol.asyncIterator = Symbol("Symbol.asyncIterator"))] = function () {
            ...
            r.prototype.p = function (t) {
                return this.u(t && t.then ? t.then(o) : o(t)),
                    this.i = new n
            }
            ,
            ...
            r.prototype.return = function (n) {
                ...
                return r.l = new Promise(function (o) {
                    var u = r.i;
                    if (null === u)
                        return null === r.t ? o(r.l) : (r.t = null,
                            o(n && n.then ? n.then(i) : i(n)));
                    r.h = n,
                        r.u = o,
                        r.i = null,
                        t(u, 2, e)
            ...
            r.prototype.throw = function (n) {
                ...
                return r.l = new Promise(function (i, e) {
                    var o = r.i;
                    if (null === o)
                        return null === r.t ? i(r.l) : (r.t = null,
                            e(n));
                    r.u = i,
                        r.i = null,
                        t(o, 2, n)
    ...
    function d(n, t) {
        ...
        return (u || o < n.length) && i.push(u + n.substr(o)),
            i
    }
    function m(n) {
        ...
        return function (r, i) {
            for (var e = "", o = i && i.encode || encodeURIComponent, u = 0; u < n.length; u++) {
                ...
                if ("string" != typeof f) {
                    ...
                    if (Array.isArray(a)) {
                        if (!f.repeat)
                            throw new TypeError('Expected "' + f.name + '" to not repeat, but got array');
                        if (0 === a.length) {
                            if (f.optional)
                                continue;
    ...
    E.prototype.toString = function (n) {
        ...
        E.prototype.getHtml = function (n) {
            return void 0 === n && (n = document),
                this.toString(n.documentElement)
        }
        ,
    ...
    var x = new E
        ...
        , C = function (n) {
            var t, r = M(n), i = {}, e = r.indexOf("#");
            e >= 0 && (t = r.slice(e + 1),
                r = r.slice(0, e));
            var o = r.indexOf("?");
            return o >= 0 && (i = L(r.slice(o + 1)),
                r = r.slice(0, o)),
            {
                hash: t,
                path: r,
    ...
    N.prototype.add = function (n, t) {
        ...
        N.prototype.push = function (n, t) {
            this.add(n, t),
                window.history && window.history.pushState(null, "", n)
        }
        ,
    ...
    var I, U = function () {
        ...
        var t = n.exports = function (n, t) {
            return t = t || function () { }
                ...
                function () {
                    ...
                    return e.then(t.bind(null, null), t),
                        e
                }
        }
            ;
        t.cb = function (n, r) {
            return t(function () {
                ...
                return t.length === n.length - 1 && t.push(this.async()),
                    n.apply(this, t)
            }, r)
        }
    }(I = {
    ...
    Y.prototype.add = function (n, t) {
            ...
            var e = new Map
                , o = i.find(function (i) {
                    ...
                    return !(!t.self || "self" !== i.name) || (r.O.reverse().forEach(function (e) {
                        o && (o = r.C(i, e, n, u),
                            t.appear || (i.from && i.to && (o = r.C(i, e, n, u, "from") && r.C(i, e, n, u, "to")),
                ...
                , u = e.get(o)
                , f = [];
            return f.push(t.appear ? "appear" : "page"),
                t.self && f.push("self"),
                u ? this.logger.info("Transition found [" + f.join(",") + "]", u) : this.logger.info("No transition found [" + f.join(",") + "]"),
                o
        }
        ,
        ...
        Y.prototype.M = function (n, t, r) {
            var i = 0;
            return (n[t] || n.from && n.from[t] || n.to && n.to[t]) && (i += Math.pow(10, r),
                n.from && n.from[t] && (i += 1),
                n.to && n.to[t] && (i += 2)),
                i
        }
    ...
    Z.prototype.get = function (n, t) {
        ...
        Z.prototype.doPage = function (n) {
            ...
            try {
                ...
                var c = r(function () {
                    ...
                    var i = function () {
                        if (a)
                            return Promise.resolve(A(e, t.next)).then(function () { })
                    }();
                    return i && i.then ? i.then(n) : n()
                }, function (n) {
                    throw u.logger.error(n),
        ...
        Z.prototype.q = function (n, t) {
            return s.do("appear", n, t),
                t.appear ? V(t.appear)(n) : Promise.resolve()
        }
        ,
        Z.prototype.B = function (n, t) {
            return s.do("leave", n, t),
                t.leave ? V(t.leave)(n) : Promise.resolve()
        }
        ,
        Z.prototype.H = function (n, t, r) {
            return s.do("enter", n, t),
                t.enter ? V(t.enter)(n, r) : Promise.resolve()
        }
        ,
        Z.prototype.$ = function (n, t, r) {
            return s.do(n, t, r),
                r[n] ? V(r[n])(t) : Promise.resolve()
        }
        ,
        Z.prototype.N = function (n, t) {
            t.appendChild(n.next.container),
                s.do("nextAdded", n)
        }
        ,
        Z.prototype.I = function (n) {
            n.current.container.remove(),
                s.do("currentRemoved", n)
        }
        ,
    ...
    return en.prototype.use = function (n, t) {
        var r = this.plugins;
        r.indexOf(n) > -1 ? this.logger.warn("Plugin [" + n.name + "] already installed.") : "function" == typeof n.install ? (n.install(this, t),
            r.push(n)) : this.logger.warn("Plugin [" + n.name + '] has no "install" method.')
    }
        ,
        en.prototype.init = function (n) {
            ...
            this.X.setAttribute("aria-live", "polite"),
                this._();
            var l = this.data.current;
            if (!l.container)
                throw new Error("[@barba/core] No Barba container found");
            if (this.history = new N,
                this.cache = new q(f),
        ...
        en.prototype.go = function (n, t, r) {
            var i;
            if (void 0 === t && (t = "barba"),
                !(i = "popstate" === t ? this.history && this.url.getPath(this.history.current.url) === this.url.getPath(n) : this.prevent.run("sameUrl", null, null, n)) || this.transitions.hasSelf)
                return r && (r.stopPropagation(),
                    r.preventDefault()),
                    this.page(n, t, i)
        }
        ,
        ...
        en.prototype.page = function (n, t, i) {
            try {
                ...
                if (e.transitions.isRunning)
                    return void e.force(n);
        ...
        en.prototype.onRequestError = function (n, t) {
            ...
            return this.cache.delete(e),
                !(this.D && !1 === this.D(n, t, e, o) || ("click" === t && this.force(e),
                    1))
        }
        ,
        en.prototype.J = function () {
            !0 !== this.prefetchIgnore && (document.addEventListener("mouseover", this.F),
        ...
        en.prototype.K = function () {
            !0 !== this.prefetchIgnore && (document.removeEventListener("mouseover", this.F),
        ...
        en.prototype.Z = function (n) {
            for (var t = n.target; t && !this.dom.getHref(t);)
                t = t.parentNode;
            if (t && !this.prevent.checkLink(t, n, t.href))
                return t
        }
        ,
