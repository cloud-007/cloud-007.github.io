    ...
    <section id="about" className="min-h-screen pt-28 pb-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          {/* ── Intro card ── */}
          <div className="bento-card md:col-span-8 p-8 flex flex-col justify-between min-h-[300px]">
            <div>
              ...
              <p className="text-zinc-400 text-base leading-relaxed max-w-md">
                Software Engineer with 3+ years building scalable EdTech
                platforms. Currently leading backend at{" "}
                <a
                  href="https://www.liilab.com/"
                  target="_blank"
          ...
          {/* ── Profile image card ── */}
          <div className="bento-card md:col-span-4 overflow-hidden relative min-h-[300px]">
            <Image
            ...
            <div className="absolute bottom-4 left-4 right-4">
              ...
              <div className="flex items-center gap-1.5 text-zinc-400 text-xs mt-1">
                ...
                Senior Software Engineer · LII Lab
              </div>
            </div>
          </div>

          {/* ── Stats — 4 cards × 3 cols each ── */}
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="bento-card md:col-span-3 p-6 flex flex-col items-center justify-center text-center"
            >
          ...
          <div className="bento-card md:col-span-7 p-6">
            ...
            <div className="mt-5 pt-4 border-t border-zinc-800 flex items-center gap-2">
              ...
              <p className="text-zinc-500 text-xs">
                Currently{" "}
                <span className="text-emerald-400 font-medium">@LII Lab</span> ·
