...
const experiences = [
  {
    ...
    achievements: [
      ...
      "Designed and built the Studio API layer for the moderator platform, covering content authoring (question bank, exam templates, stimulus management), expert evaluation queue with AI-vs-human score comparison, exam rejudge pipelines, and KPI analytics endpoints for subscription metrics, user practice activity, and engagement data",
